  ...
  return (
    <section id="about" className="min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 bg-[#0C0C0C]">
      ...
      <div className="mt-10 sm:mt-14 md:mt-16 text-[#D7E2EA] font-medium text-center leading-relaxed max-w-[640px] text-[clamp(1.25rem,2.6vw,1.75rem)]">
        <AnimatedText text="With more than five years of experience in construction estimation, i focus on roofing, cladding, and earthworks for australian clients, i truly enjoy building precise, reliable numbers that help construction teams deliver with confidence. Let's build your next project together!" />
      </div>
